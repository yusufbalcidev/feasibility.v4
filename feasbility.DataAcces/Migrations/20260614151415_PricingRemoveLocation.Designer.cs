...
namespace feasibility.DataAccess.Migrations
{
    ...
    [Migration("20260614151415_PricingRemoveLocation")]
    partial class PricingRemoveLocation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("feasibility.Entity.Entities.FeasibilityPricing.PricingStation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("AnnualOpex")
                        .HasColumnType("decimal(18,4)");

                    b.Property<int>("AnnualOpexCurrency")
                        .HasColumnType("int");

                    b.Property<decimal>("AnnualOpexUsd")
                        .HasColumnType("decimal(18,4)");
                    ...
                    b.Property<decimal>("DailyKwhPerSocket")
                        .HasColumnType("decimal(18,4)");
                    ...
                    b.Property<decimal>("GridElectricityCost")
                        .HasColumnType("decimal(18,6)");

                    b.Property<decimal>("GridElectricityCostHigh")
                        .HasColumnType("decimal(18,6)");

                    b.Property<decimal>("GridElectricityCostLow")
                        .HasColumnType("decimal(18,6)");

                    b.Property<decimal>("HardwareCost")
                        .HasColumnType("decimal(18,4)");

                    b.Property<int>("HardwareCostCurrency")
                        .HasColumnType("int");

                    b.Property<decimal>("HardwareCostTl")
                        .HasColumnType("decimal(18,4)");
                    ...
                    b.Property<Guid>("PricingStudyId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PricingStudyId");

                    b.ToTable("PricingStations", (string)null);
                });
            ...
            modelBuilder.Entity("feasibility.Entity.Entities.FeasibilityPricing.PricingStation", b =>
                {
                    b.HasOne("feasibility.Entity.Entities.FeasibilityPricing.PricingStudy", "PricingStudy")
                        .WithMany("Stations")
                        .HasForeignKey("PricingStudyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
